    ...
    <div className="monitoring-container">
      <header>
        ...
        <div className="selector-container">
          <button
            className={`${
              displayGlobalChart ? "button-sm-olive-fullfilled " : "button-sm-olive-outlined"
            }`}
          ...
          <button
            className={`${
              displayDetailsChart ? "button-sm-olive-fullfilled " : "button-sm-olive-outlined"
            }`}
            onClick={() => handleClickDisplayButton(displayDetailsChart, setDisplayDetailsChart)}
          >
